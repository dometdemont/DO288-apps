// Gratitude to https://github.com/jeremyfa/yaml.js/blob/develop/dist/yaml.min.js for this minified YAML parser / encoder
// Usage: 
// myvar=YAML.parse(YAML string)
// myyaml=YAML.stringify(myvar)
